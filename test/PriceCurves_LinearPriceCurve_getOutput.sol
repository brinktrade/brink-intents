...
contract PriceCurves_LinearPriceCurve_getOutput is Test, Helper  {
  ...
  function testLinearPriceCurve_largeTotal_getOutput () public {
    ...
    uint total = 15_000_000_000_000_000 * 10**18;
    ...
    uint output0 = linearPriceCurve.getOutput(total, 0, input, curveParams);
    assertEq(output0/input, price0/Q96);

    // last 1 (10**18) input, should be swapped at a price approaching price1
    uint output1 = linearPriceCurve.getOutput(total, total-input, input, curveParams);
